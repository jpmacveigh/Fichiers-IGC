...
print("Il est en moment (heure UTC) :", datetime.datetime.utcnow().isoformat(), " time_stamp: ", time.gmtime())
print (getTimeStamp(2011,3,13,8,6,40))
print (getDateTime (1309526505))
print (getTimeStamp(2011,7,1,15,21,45))
